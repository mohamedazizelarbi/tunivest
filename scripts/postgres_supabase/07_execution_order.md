...
3. scripts/postgres_supabase/02_security_policies.sql
4. scripts/postgres_supabase/03_seed_data.sql
5. scripts/postgres_supabase/05_plpgsql_functions_procedures_triggers.sql
6. scripts/postgres_supabase/04_queries_examples.sql
7. scripts/postgres_supabase/06_annex_inventory.sql
